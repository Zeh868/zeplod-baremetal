...
function(bm_add_qemu_example TARGET)
    ...
    add_executable(${TARGET}.elf
        ...
        "${ZEPLOD_ROOT}/platform/boot/qemu_cortex_m0/startup_qemu_cm0.s"
        "${ZEPLOD_ROOT}/platform/boot/qemu_cortex_m0/crt0_qemu.c"
        ${EX_EXTRA_SOURCES}
    )
    ...
    target_link_options(${TARGET}.elf PRIVATE
        "-T${ZEPLOD_ROOT}/platform/boot/qemu_cortex_m0/linker.ld"
        "-nostartfiles"
        "-Wl,--gc-sections"
        "--specs=rdimon.specs"
    )
